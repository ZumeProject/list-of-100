...
class LanguageService {
  ...
  final List<SupportedLanguage> supportedLanguages = [
    ...
    const SupportedLanguage(code: 'zhhk', name: '廣東話 (Cantonese)'),
    const SupportedLanguage(code: 'zhcn', name: '简体中文 (Chinese Simplified)'),
    const SupportedLanguage(code: 'zhtw', name: '繁體中文 (Chinese Traditional)'),
    ...
    const SupportedLanguage(code: 'pa_pk', name: 'پنجابی (Western Punjabi)'),
    ...
    const SupportedLanguage(code: 'swa', name: 'Kiswahili (Swahili)'),
